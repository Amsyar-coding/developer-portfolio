  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "iyaadamsyar.syahrizal@gmail.com",
      link: "mailto:iyaadamsyar.syahrizal@gmail.com"
    },
    {
      icon: <MapPin className="w-5 h-5" />,
      title: "Location",
      content: "Swansea, UK",
      link: "https://www.google.com/maps/search/Swansea,%20Wales"
    }
  ];
        ...
        <div className="text-center mt-16 animate-fade-in">
          <div className="bg-gradient-hero p-8 rounded-2xl text-hero-text">
            ...
            <Button
              ...
              onClick={() => window.open('mailto:iyaadamsyar.syahrizal@gmail.com?subject=Project Inquiry', '_blank')}
            >
