          ...
          <div className="space-y-8 animate-slide-up">
            <div>
              <h3 className="text-2xl font-bold mb-4">
                Hi there! I'm a passionate aspiring software engineer
              </h3>
              <p className="text-muted-foreground leading-relaxed mb-6">
                From a young age, I was fascinated by the world of coding, 
                first inspired by the platform Scratch. This early interest 
                propelled me toward a career in the computing field, aiming
                to deepen my understanding and connect with like-minded individuals. 

              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                To enhance my knowledge, I enrolled into the CS50x course from Harvard University, 
                participating in all the lectures, allowing me to be proficient in languages such as 
                C and Python, and single handedly developed projects like a chess game with basic AI using C#. 
                I explored algorithms, appreciating their situational efficiency, and delved into Artificial 
                Intelligence through literature, notably 'Artificial Intelligence; A Guide 
                to Intelligent Systems' by Negnevitsky. This journey revealed the vast potential of AI in our future.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                I'm currently focused on Java, TypeScript, and C, but I'm always 
