        ...
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-slide-up">
            <span className="bg-gradient-primary bg-clip-text text-transparent">
              Iyaad Amsyar Syahrizal
            </span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground mb-8 max-w-3xl mx-auto animate-slide-up">
            Aspiring Software Engineer also looking to break into Cybersecurity
          </p>
          
          {/* Description */}
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in">
            I specialize in Java and Python, and am also capable of building scalable web applications using React, TypeScript, and Node.js. 
          ...
          <div className="flex justify-center space-x-6 mb-16 animate-fade-in">
            <a
              href="https://github.com/Amsyar-coding"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/iyaad-amsyar-syahrizal-b50433336/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-secondary/20 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110"
            >
            ...
            <a
              href="mailto:iyaadamsyar.syahrizal@gmail.com"
              className="p-3 rounded-full bg-secondary/20 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110"
            >
              <Mail size={24} />
            </a>
